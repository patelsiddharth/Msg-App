      ...
      <div class="col-md-6">
        ...
        <form action="register.php" method="post">
          <div class="form-group">
            ...
            <input type="text" name="un" class="form-control" placeholder="USERNAME" id="name" required="">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="password" name="cp" class="form-control" placeholder="PASSWORD" id="Cp" required="">
          </div>
        ...
        <?php
          if(isset($_GET["error"]))
          {
              echo "<b>Password and Confirm Password does not match.</b>";
          }
